...
<div align="center">
		<div style="color: white; font-size: 100px; height: 60px; padding-top: 50px; text-shadow: 0px 0px 9px #D1D1D1">
			
			Mobello
		</div>
		<div style="color: white; margin-bottom: 180px;">
			HTML5 framwrok for building mobile webapp
		</div>
