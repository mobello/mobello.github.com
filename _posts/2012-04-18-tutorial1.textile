...
pre(prettyprint).. $class('tau.sample.ContactListController').extend(tau.ui.TableSceneController).define({
  /**
...
pre(prettyprint).. $class('tau.sample.ContactInfo').extend(tau.ui.SceneController).define({
  /**
   * 
   * @param name
   * @param phone
