...
bq. [{group: '친구', name: 'Steve Jobs', mobile: '011-1024-1111', company: 'Apple Inc.', position: 'CEO', img: '/img/stevejobs.jpg'},
...
bq. $class('tau.sample.ContactsController').extend(tau.ui.SequenceNavigator).define({
  init : function() {
...
bq.. $class('tau.sample.ContactListController').extend(tau.ui.TableSceneController).define({
  /**
...
bq.. $class('tau.sample.ContactInfo').extend(tau.ui.SceneController).define({
  /**
   * 
   * @param name
   * @param phone
...
* "소스코드 다운로드":tutorial1-source.zip