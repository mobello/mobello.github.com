...
Mobello UI Framework은 Web 개발 경험을 가진 개발자들이라면 누구라도 자기가 원하는 App을 쉽게 개발할 수 있도록 지원합니다. 이 문서는 Mobello UI Framework을 이용한 App 개발 과정을 간략하게 소개합니다. 뿐만 아니라 코딩, UI 디자인, 디버깅을 포함한 기본적인 개발 단계도 같이 볼 수 있습니다.
...
Mobello UI Framework 통합 개발환경(IDE)을 이용하면 이 과정을 자동화된 방법으로진행할 수 있습니다.
